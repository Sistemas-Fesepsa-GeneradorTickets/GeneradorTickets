...
const btnTareaPendiente = document.getElementById("btnTareaPendiente");
const btnTareaCompletada = document.getElementById("btnTareaCompletada");

btnTareaPendiente.onclick = function(){
     obtenerRequerimientosBDPendientes()
}

btnTareaCompletada.onclick = function(){
    obtenerRequerimientosBDCompletados()
}
...
async function obtenerRequerimientosBDPendientes(){
 ...
 async function obtenerRequerimientosBDCompletados(){
